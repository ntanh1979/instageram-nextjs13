            ...
            <div className="shadow-sm border-b sticky top-0 bg-white z-30">
                        ...
                        {/* Left */}
                            ...
                            <div className="flex flex-row space-x-4 justify-center items-center">
                                ...
                                <img src={`https://i.pravatar.cc/150?img=${Math.ceil(Math.random()*70)}`} className='h-10 w-10 rounded-full  cursor-pointer hover:scale-125 transition-transform duration-200 ease-out p-[1.5px] border border-blue-300'/>
